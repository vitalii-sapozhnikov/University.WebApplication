...
namespace University.WebApi.Migrations
{
    ...
    [Migration("20240215120305_LecturerDisciplineIgnored")]
    partial class LecturerDisciplineIgnored
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Models.Models.MethodologicalPublication", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("MethodologicalPublication");
                });
            ...
            modelBuilder.Entity("Models.Models.ScientificPublication", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("ScientificPublication");
                });
